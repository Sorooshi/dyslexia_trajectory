...
if __name__ == "__main__":
    ...
    if (model_name == "conv_grad" or model_name == "conv_grad_deep") and run > 0:
        if run == 1: # tune the number of epoch (done)
            ...
            saving_results(final_results, f"{epoch_num}{data_name}_{model_name}_{num_classes}_full")
            saving_results(final_results_tr, f"{epoch_num}{data_name}_{model_name}_{num_classes}_per_barches")
